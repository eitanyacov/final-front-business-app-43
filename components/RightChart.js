...
const RightChart = () => {
  ...
  const data = [
    { name: "ינואר", הכנסה: januar, pv: 2400, amt: 2400 },
    { name: "פברואר", הכנסה: february, pv: 2400, amt: 1760 },
    { name: "מרץ", הכנסה: march, pv: 1580, amt: 2170 },
    { name: "אפריל", הכנסה: april, pv: 870, amt: 2768 },
    { name: "מאי", הכנסה: may, pv: 980, amt: 1877 },
    { name: "יוני", הכנסה: june, pv: 650, amt: 2768 },
    { name: "יולי", הכנסה: july, pv: 456, amt: 2295 },
    { name: "אוגוסט", הכנסה: august, pv: 1024, amt: 2489 },
    { name: "'ספט", הכנסה: september, pv: 445, amt: 988 },
    { name: "'אוק", הכנסה: october, pv: 666, amt: 1456 },
    { name: "נובמבר", הכנסה: november, pv: 666, amt: 1456 },
    { name: "'דצמ", הכנסה: december, pv: 666, amt: 1456 },
